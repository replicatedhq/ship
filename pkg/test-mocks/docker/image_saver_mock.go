...
// Source: github.com/replicatedcom/ship/pkg/lifecycle/render/docker (interfaces: ImageSaver)
...
import (
	...
	docker "github.com/replicatedcom/ship/pkg/lifecycle/render/docker"
)
...
func (m *MockImageSaver) SaveImage(arg0 context.Context, arg1 docker.SaveOpts) chan interface{} {
