...
func (m *MockRenderer) Execute(arg0 api.GitHubAsset, arg1 []libyaml.ConfigGroup, arg2 api.ReleaseMetadata, arg3 map[string]interface{}) func(context.Context) error {
