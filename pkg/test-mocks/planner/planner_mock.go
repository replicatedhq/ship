...
// Source: github.com/replicatedcom/ship/pkg/lifecycle/render/plan (interfaces: Planner)
...
func (m *MockPlanner) Build(arg0 []api.Asset, arg1 []libyaml.ConfigGroup, arg2 api.ReleaseMetadata, arg3 map[string]interface{}) plan.Plan {
