...
func RootCmd() *cobra.Command {
	...
	cmd.PersistentFlags().Bool(constants.KustomizeInStateFlag, false, "persist kustomize info (patches and resources) in the ship state in addition to the overlays directory")
