...
```shell
curl -sSL https://github.com/replicatedhq/ship/releases/download/v0.34.0/ship_0.34.0_linux_amd64.tar.gz | tar xv && sudo mv ship /usr/local/bin
```

- To download the latest MacOS build, you can either run:
```shell
curl -sSL https://github.com/replicatedhq/ship/releases/download/v0.34.0/ship_0.34.0_darwin_amd64.tar.gz | tar xv && sudo mv ship /usr/local/bin
```
